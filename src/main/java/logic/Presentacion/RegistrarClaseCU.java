                                                                ...
                                                                .addGroup(layout.createParallelGroup(
                                                                                ...
                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                .addGroup(layout
                                                                                                                ...
                                                                                                                .addGroup(layout.createSequentialGroup()
                                                                                                                                .addGap(70, 70, 70)
                                                                                                                                .addComponent(jFileChooserImgClase,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                389,
                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                                                                .addGap(88, 88, 88)))));
        ...
        private void jButtonRCAActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButtonRCAActionPerformed
                try {
                        ...
                        LocalDate fechaInicio = selectedDate.toInstant()
                                        .atZone(jDateChooserFechaInicio.getCalendar().getTimeZone().toZoneId())
                                        .toLocalDate();

                        Date selectedDate2 = jDateChooserFechaAlta.getDate();
                        LocalDate fechareg = selectedDate2.toInstant()
                                        .atZone(jDateChooserFechaAlta.getCalendar().getTimeZone().toZoneId())
                                        .toLocalDate();
                        ...
                        controllerAltaClase.addClase(nombre, fechaInicio, horaInicio, url, fechareg, profesor,
                                        imgBase64,
                                        actividad);
